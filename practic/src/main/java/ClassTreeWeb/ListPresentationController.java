...
public class ListPresentationController {
    ...
    public String getList() {
        ...
        for (int i = 0; i < list.size(); i++) {
            ...
            result += "<li>" + listItem + " <a href=\"edit/" + i + "\">Change tree element</a> </li>";
        }
        result += "    </ul>" +
                "      <br/><center>" +
                "      <form method=\"post\" action=\"output_tree_elements\">" +
                "        <input type=\"submit\" value=\"Output tree elements\"/>" +
                "      </form></center>" +
                "  </body>" +
                "</html>";
        return result;
